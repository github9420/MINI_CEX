...
//MainActivity
public class AfterLoginActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, TabHost.OnTabChangeListener {
    private final static String TAG = AfterLoginActivity.class.getSimpleName();
    private FragmentTabHost mTabHost;
    private LayoutInflater layoutInflater;
    private Class fragmentArray[] = { NewsFragment.class, EvaluationFragment.class,InquireFragment.class,TeachFragment.class,SetupFragment.class };
    private int imageViewArray[] = { R.drawable.ic_home_black_24dp, R.drawable.ic_mode_edit_black_24dp, R.drawable.ic_search_black_24dp, R.drawable.ic_import_contacts_black_24dp, R.drawable.ic_settings_black_24dp};
    //TCLIU This two string array need to get return value type
    private String StudentButtomViewArray[] = { "新聞", "評量","查詢","教學","設定"};
    private String textViewArray[] = {  "新聞", "評量","查詢","教學","設定"};
    ...
    private void initPage() {
        ...
        EvaluationFragment fragment2 = new EvaluationFragment();
        InquireFragment fragment3 = new InquireFragment();
        TeachFragment fragment4 = new TeachFragment();
        SetupFragment fragment5 = new SetupFragment();
        EditInformationFragment fragment6 = new EditInformationFragment();
        list.add(fragment1);
        list.add(fragment2);
        list.add(fragment3);
        list.add(fragment4);
